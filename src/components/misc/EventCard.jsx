		...
		>
			<button
				...
				style={{
					width: "100%",
					padding: "14px 18px",
					backgroundColor: "var(--btn-regular-bg, #ffffff)",
					borderRadius: 12,
					border: "none",
					textAlign: "left",
					fontFamily: "inherit",
					...
					transition:
						"opacity 0.8s ease-out, transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.3s ease",
					outline: "none",
				}}
			>
				<div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
					<div
						style={{
							fontWeight: 700,
							fontSize: 16,
							color: "var(--btn-content, #3d6897)",
						}}
					>
						{event.title}
					</div>
					<div style={{ fontWeight: 500, fontSize: 14 }}>{event.result}</div>
				</div>
