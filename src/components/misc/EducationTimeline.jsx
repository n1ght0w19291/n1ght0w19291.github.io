	...
	return (
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
				<strong style={{ fontSize: 18 }}>{edu.name}</strong>
				<span style={{ fontSize: 15 }}>{edu.department}</span>
				<span style={{ fontSize: 14 }}>{edu.status}</span>
				<small style={{ fontSize: 13 }}>{edu.period}</small>
			</div>
		</div>
	);
};
