...
<ChallengeCard
	event="My First CTF & Pre-exam 2025"
	rank={186}
	total={389}
	challenges={[
		...
		{ name: "AIS3 Tiny Server (Misc)", category: "Misc", anchor: "ais3-tiny-server-misc" },
		{ name: "AIS3 Tiny Server (Rev)", category: "Rev", anchor: "ais3-tiny-server-rev" },
