---
title: "SekaiCTF 2025"
pubDatetime: 2025-08-18T08:00:00+08:00
description: "SekaiCTF 2025 writeup"
ogImage: "../../assets/images/blog/SekaiCTF2025/cover.png"
tags: ["CTF Writeup"]
draft: false
---
...
<ChallengeCard
  ...
  total={1060}
  challenges={[
    { name: "My Flask App", category: "Web" },
    { name: "Sanity Check", category: "Misc" },
  ]}
/>

![score](../../assets/images/blog/SekaiCTF2025/image.png)
...
![](../../assets/images/blog/SekaiCTF2025/IMG-20250816122257236.png)

這一題在 `Dockerfile` 可以看到 flag 的檔名後面有隨機的英文數字，不能直接猜

![](../../assets/images/blog/SekaiCTF2025/IMG-20250816125529384.png)

`app.py` 裡面有使用 `filename` 讀檔功能，但是又不確定檔案名稱是甚麼，只能先去常見目錄查找

![](../../assets/images/blog/SekaiCTF2025/IMG-20250816125551123.png)

最後在 `/proc/self/mounts` 裡面找到 flag.txt 的名稱

![](../../assets/images/blog/SekaiCTF2025/IMG-20250816125026406.png)

就找到 flag 了

![](../../assets/images/blog/SekaiCTF2025/IMG-20250816125128034.png)
...
![](../../assets/images/blog/SekaiCTF2025/IMG-20250816125313918.png)
