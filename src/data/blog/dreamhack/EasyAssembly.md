...
![enc_flag](../../../assets/images/blog/dreamhack/EasyAssembly/image.png)

`check_password`中可以看到`enc_flag[i] ^ len ^ password[i]`

![check_password](../../../assets/images/blog/dreamhack/EasyAssembly/image-2.png)
...
![flag](../../../assets/images/blog/dreamhack/EasyAssembly/image-1.png)
