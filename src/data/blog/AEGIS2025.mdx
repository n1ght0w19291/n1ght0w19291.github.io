...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  <img src={img922.src} style="width: 24%; height: auto;border-radius: 4px;" />
  <img src={img975.src} style="width: 24%; height: auto;border-radius: 4px;" />
  <img src={img022.src} style="width: 24%; height: auto;border-radius: 4px;" />
  <img src={img062.src} style="width: 24%; height: auto;border-radius: 4px;" />
</div>
...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  <img src={imgY.src} style="width: 45%; height: auto; border-radius: 4px;" />
  <img src={imgX.src} style="width: 45%; height: auto; border-radius: 4px;" />
</div>
