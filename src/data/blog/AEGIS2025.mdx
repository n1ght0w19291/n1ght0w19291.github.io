...
pubDatetime: 2025-09-28T19:00:00+08:00
ogImage: "../../assets/images/blog/AEGIS2025/cover.png"
tags: ["CTF Writeup"]
draft: false
---
...
import img922 from "../../assets/images/blog/AEGIS2025/IMG-20250927190121922.png";
import img975 from "../../assets/images/blog/AEGIS2025/IMG-20250927190121975.jpg";
import img022 from "../../assets/images/blog/AEGIS2025/IMG-20250927190122022.png";
import img062 from "../../assets/images/blog/AEGIS2025/IMG-20250927190122062.png";
import imgX from "../../assets/images/blog/AEGIS2025/X.jpg";
import imgY from "../../assets/images/blog/AEGIS2025/Y.jpg";

<ChallengeCard
  event="2025 AEGIS神盾盃 初賽"
  rank={15}
  total={40}
  challenges={[
    { name: "Amnesia Dose", category: "Web" },
    { name: "random multi", category: "Crypto" },
  ]}
/>
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190121880.png)

隊伍排名：15 / 40

![](../../assets/images/blog/AEGIS2025/Pasted%20image%2020250927190222.png)
...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  <ResponsiveImage src={img922} alt="AEGIS challenge screenshot" sizes="(max-width: 768px) 24vw, 240px" style="width: 24%; height: auto; border-radius: 4px;" />
  <ResponsiveImage src={img975} alt="AEGIS challenge screenshot" sizes="(max-width: 768px) 24vw, 240px" style="width: 24%; height: auto; border-radius: 4px;" />
  <ResponsiveImage src={img022} alt="AEGIS challenge screenshot" sizes="(max-width: 768px) 24vw, 240px" style="width: 24%; height: auto; border-radius: 4px;" />
  <ResponsiveImage src={img062} alt="AEGIS challenge screenshot" sizes="(max-width: 768px) 24vw, 240px" style="width: 24%; height: auto; border-radius: 4px;" />
</div>
...
<div style="display: flex; gap: 10px; flex-wrap: wrap;">
  <ResponsiveImage src={imgY} alt="Cipher Restaurant screenshot" sizes="(max-width: 768px) 45vw, 420px" style="width: 45%; height: auto; border-radius: 4px;" />
  <ResponsiveImage src={imgX} alt="Cipher Restaurant screenshot" sizes="(max-width: 768px) 45vw, 420px" style="width: 45%; height: auto; border-radius: 4px;" />
</div>
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190122101.png)

第一個想到的是 `admin` ，按下 `Retrieve Password` 發現會顯示 `I have sent the password to a****@***********` ，猜測在使用者存在的情況下 `@` 前面應該是輸入的使用者名稱

![](../../assets/images/blog/AEGIS2025/IMG-20250927190122141.png)
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190122178.png)  
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190122226.png)
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190122273.png)

![](../../assets/images/blog/AEGIS2025/IMG-20250927190122311.png)
...
![](../../assets/images/blog/AEGIS2025/IMG-20250927190122353.png)
