---
title: "PicoCTF 2025"
pubDatetime: 2025-03-20T08:00:00+08:00
description: "picoCTF 2025 writeup"
ogImage: "../../assets/images/blog/picoCTF/picoCTFlogo.png"
...
<ChallengeCard
  ...
  total={10460}
  challenges={[
    { name: "Cookie Monster Secret Recipe", category: "Web" },
    { name: "head-dump", category: "Web" },
    { name: "SSTI1", category: "Web" },
    { name: "EVEN RSA CAN BE BROKEN", category: "Crypto" },
    { name: "Guess My Cheese (Part 1)", category: "Crypto" },
    { name: "Guess My Cheese (Part 2)", category: "Crypto" },
    { name: "hashcrack", category: "Crypto" },
    { name: "Bitlocker-1", category: "Forensics" },
    { name: "Bitlocker-2", category: "Forensics" },
    { name: "Event-Viewing", category: "Forensics" },
    { name: "Ph4nt0m_1ntrud3r", category: "Forensics" },
    { name: "RED", category: "Forensics" },
  ]}
/>
...
231 / 10460
![team rank - 231/10460](../../assets/images/blog/picoCTF2025/summary/image-2.png)

:::

:::note[團隊成績]

![team score - 5510](../../assets/images/blog/picoCTF2025/summary/image.png)
:::
...
![individual score - 1860](../../assets/images/blog/picoCTF2025/summary/image-1.png)
:::
...
![cookie](../../assets/images/blog/picoCTF2025/Web/CookieMonsterSecretRecipe/image.png)

拿去 decode base64

![flag](../../assets/images/blog/picoCTF2025/Web/CookieMonsterSecretRecipe/image-1.png)

### head-dump

index 中有一則關於 nodejs

![nodejs](../../assets/images/blog/picoCTF2025/Web/head-dump/image.png)

source code 裡面可以看到`#API Documentation`可以連結到`/api-docs`

![api docs](../../assets/images/blog/picoCTF2025/Web/head-dump/image-1.png)

![swagger](../../assets/images/blog/picoCTF2025/Web/head-dump/image-2.png)

在 swagger 中發現 `Diagnosing /heapdump`

![heapdump](../../assets/images/blog/picoCTF2025/Web/head-dump/image-4.png)

按下 Download file

在檔案中找到 flag

![flag](../../assets/images/blog/picoCTF2025/Web/head-dump/image-5.png)
...
![result](../../assets/images/blog/picoCTF2025/Web/SSTI1/image.png)
...
![flag](../../assets/images/blog/picoCTF2025/Web/SSTI1/image-1.png)
...
![flag](../../assets/images/blog/picoCTF2025/Crypto/EVEN_RSA_CAN_BE_BROKEN/image.png)
...
![flag](<../../assets/images/blog/picoCTF2025/Crypto/Guess_My_Cheese_(Part_2)/image.png>)

這次的 cheese 是`Gouda`，加鹽的 hex 是`9f`

### hashcrack

![start](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image.png)

題目提到`weakly hashed`，直接查詢`482c811da5d5b4bc6d497ffa98491e38`

![search](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-1.png)

可知這就是`password123`

![second hash](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-2.png)

用線上工具[SHA-1 Center](https://sha1.gromweb.com/)

![result2](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-3.png)

`b7a875fc1ea228b9061041b7cec4bd3c52ab3ce3`是`letmein`

![third hash](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-5.png)

用線上工具[CrackStation](https://crackstation.net/)

![result3](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-4.png)

`916e8c4f79b25028c9e467f1eb8eee6d6bbdff965f9928310ad30a8d88697745`是`qwerty098`

![flag](../../assets/images/blog/picoCTF2025/Crypto/hashcrack/image-6.png)
...
![mount image](../../assets/images/blog/picoCTF2025/Forensics/Bitlocker-1/image.png)
...
![hashcat](../../assets/images/blog/picoCTF2025/Forensics/Bitlocker-1/image-1.png)
...
![flag.txt](../../assets/images/blog/picoCTF2025/Forensics/Bitlocker-1/image-2.png)

```
cat ./test/decrypted/flag.txt
```

![flag](../../assets/images/blog/picoCTF2025/Forensics/Bitlocker-1/image-3.png)
...
![flag](../../assets/images/blog/picoCTF2025/Forensics/Bitlocker-2/image-1.png)

### Event-Viewing

這一題要找到三段 flag

![logs](../../assets/images/blog/picoCTF2025/Forensics/Event-Viewing/image.png)

![flag1](../../assets/images/blog/picoCTF2025/Forensics/Event-Viewing/image-1.png)

把`cGljb0NURntFdjNudF92aTN3djNyXw==`拿去 decode

因為第一個拿到的是 base64 形式，推斷剩下兩段都是 base64 ，用`尋找`去搜尋`==`或`=`結尾的字串，加快找 flag 的速度

![flag2](../../assets/images/blog/picoCTF2025/Forensics/Event-Viewing/image-2.png)
...
![flag3](../../assets/images/blog/picoCTF2025/Forensics/Event-Viewing/image-3.png)
...
![wireshark](../../assets/images/blog/picoCTF2025/Forensics/Ph4nt0m_1ntrud3r/image.png)
...
![cyberchef](../../assets/images/blog/picoCTF2025/Forensics/Ph4nt0m_1ntrud3r/image-1.png)

題目提到`The attacker has cleverly concealed his moves in well timely manner.`  
對時間進行排序

![sorted](../../assets/images/blog/picoCTF2025/Forensics/Ph4nt0m_1ntrud3r/image-2.png)
...
![flag](../../assets/images/blog/picoCTF2025/Forensics/Ph4nt0m_1ntrud3r/image-3.png)
...
![result](../../assets/images/blog/picoCTF2025/Forensics/RED/image.png)

得到 flag

![flag](../../assets/images/blog/picoCTF2025/Forensics/RED/image-1.png)
