---
title: "WHY2025 CTF"
pubDatetime: 2025-08-12T08:00:00+08:00
description: "WHY 2025 CTF writeup"
ogImage: "../../assets/images/blog/WHY2025/image.png"
tags: ["CTF Writeup"]
draft: false
---
  ...
  challenges={[
    {
      name: "ToShredsYouSay",
      category: "Forensics",
      anchor: "toshredsyousay-100",
      difficulty: "100",
    },
    {
      name: "Ransomware attack",
      category: "Net",
      anchor: "ransomware-attack-50",
      difficulty: "50",
    },
    {
      name: "Planets",
    ...
    {
      name: "WHY2025 CTF TIMES",
      category: "Web",
      anchor: "why2025-ctf-times-50",
      difficulty: "50",
    },
    { name: "Buster", category: "Web", anchor: "buster-50", difficulty: "50" },
    {
      name: "Twenty Three Drivers",
      category: "Misc",
      anchor: "twenty-three-drivers-50",
      difficulty: "50",
    },
    {
      name: "Keypad",
...
![alt text](../../assets/images/blog/WHY2025/IMG-20250809173348202.png)

而且我到第二天才知道可以切到這種比較好找題目的介面 www

![](../../assets/images/blog/WHY2025/IMG-20250809173422618.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250812005143991.png)

主辦方還有國家單獨顯示的功能ㄟ超酷

![](../../assets/images/blog/WHY2025/IMG-20250812005202144.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809020623828.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809021539905.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809022836481.png)

```txt
flag{ad1c53bf1e00a9239d29edaadcda2964}
```

![](../../assets/images/blog/WHY2025/IMG-20250809022722291.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809003809091.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809005159998.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809005401005.png)

啊但是，解太慢，隊友寫掉了嘿嘿，沒注意 xd

![](../../assets/images/blog/WHY2025/IMG-20250809005351606.png)

### WHY2025 CTF TIMES (50)

一進去網站會有很多彈出視窗，我剛開始還在懷疑是不是跟 cookie 有關

![](../../assets/images/blog/WHY2025/IMG-20250809223853062.png)

後來在 source code 那邊看到混淆過的 JavaScript，拿去 [JavaScript Deobfuscator](https://deobfuscate.relative.im/) 解混淆

![](../../assets/images/blog/WHY2025/IMG-20250809223937374.png)

就能在程式碼裡面找到 flag

![](../../assets/images/blog/WHY2025/IMG-20250809224122360.png)

```txt
flag{2d582cd42552e765d2658a14a0a25755}
```

![](../../assets/images/blog/WHY2025/IMG-20250809223814364.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250810013529873.png)

掃描到後面發現要一直手動跳過很麻煩，不如把目前掃到最長的目錄作為新目錄重新開始掃

![](../../assets/images/blog/WHY2025/IMG-20250810014051064.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250810015617866.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250810015553291.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250811235946875.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809181812279.png)

實際輸入到 input 裡面再按下 `Check Code`，就拿到票了 xddd

![](../../assets/images/blog/WHY2025/IMG-20250809181838010.png)

我把 qrcode 拿去給 google 掃，就得到 flag 了

![](../../assets/images/blog/WHY2025/IMG-20250809181917161.png)

```txt
flag{5c2eb61a39c2528008508b687d0af328}
```

![](../../assets/images/blog/WHY2025/IMG-20250809181943421.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809212428572.png)

然後資料夾裡面還有兩張圖片，分別是密碼盤的對應訊號，以及密碼盤每個按鍵可以代表的數字與英文字母 (只截出圖片的重點)
從對應訊號的圖片裡可以知道，當每一個按鍵被按下，就會有兩個訊號產生變化，舉例：當按鍵 1 被按下，就會影響到 d1 以及 d4。
![](../../assets/images/blog/WHY2025/IMG-20250809220529011.png)

![](../../assets/images/blog/WHY2025/IMG-20250809220506310.png)

再回去看訊號的圖，會發現最一開始是快速的三次 d3 以及 d4 訊號改變

![](../../assets/images/blog/WHY2025/IMG-20250812003605065.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250812003630031.png)

然後 d4 ~ d7 這部分被按下的時候會出現這種很短的波型

![](../../assets/images/blog/WHY2025/IMG-20250812003755824.png)
...
![](../../assets/images/blog/WHY2025/IMG-20250809213004208.png)
