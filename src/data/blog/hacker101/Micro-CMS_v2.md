...
image: ""
tags: ["hacker101", "Web"]
parentPost: "hacker101"
draft: false
---

# Micro-CMS v2

![index](../../../assets/images/blog/hacker101/Micro-CMS_v2/image.png)

`changelog` 說已經修正了 v1 的眾多安全漏洞和常規功能錯誤，並且加了身分驗證

![changelog](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-1.png)

`create a new page` 按下去之後會是到 `/login`

![login](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-2.png)

看到 input 猜一下是不是 sql injection，先試試看帳號 `admin' or '1'=='1'--` 密碼 `123`，遇到 internal server error

![internal server error](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-3.png)
...
![login success](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-4.png)

接著到 `Private Page` 就可以得到第一個 flag

![flag0](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-5.png)

先試試看還有沒有上一題的 xss 漏洞，但是都沒有成功

![test xss](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-6.png)
...
![hint](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-7.png)
...
![test edit page](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-8.png)  
![test create page](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-9.png)

都試過之後，在 拿到 flag

![flag1](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-10.png)
...
![sqlmap result](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-11.png)

得到 flag2

![flag2](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-12.png)

---

![end](../../../assets/images/blog/hacker101/Micro-CMS_v2/image-13.png)
