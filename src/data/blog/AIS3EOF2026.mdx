...
<ResponsiveImage src={DjangoImg} alt="Welcome To The Django screenshot" style="max-width: 70%; height: auto;" />
...
<ResponsiveImage src={FunImg} alt="fun challenge flag screenshot" style="max-width: 50%; height: auto;" />
