...
modDatetime: 2026-09-26T00:21:00+08:00
tags: ["picoCTF", "Misc", "Forensics", "Web", "Crypto", "Reverse", "pwnable"]
parentPost: "picoctf"
draft: false
---
...
<ChallengeCard
  event="picoMini by CMU-Africa 練習"
  challenges={[
    { name: "Log Hunt", category: "General Skills", difficulty: "Easy" },
    { name: "Riddle Registry", category: "Forensics", difficulty: "Easy" },
    { name: "Hidden in plainsight", category: "Forensics", difficulty: "Easy" },
    { name: "Flag in Flame", category: "Forensics", difficulty: "Easy" },
    { name: "Corrupted file", category: "Forensics", difficulty: "Easy" },
    { name: "Crack the Gate 1", category: "Web", difficulty: "Easy" },
    { name: "Crack the Gate 2", category: "Web", difficulty: "Medium" },
    { name: "byp4ss3d", category: "Web", difficulty: "Medium" },
    { name: "Crack the Power", category: "Crypto", difficulty: "Medium" },
    {
      name: "M1n10n'5_53cr37",
...
JPEG 通常以 `ff d8 ff` 開頭；這個檔案目前是 `5c 78 ff e0`，所以把前兩個錯誤位元組改回 `ff d8`
...
![.htaccess 將 JPG 副檔名設定為 PHP 執行](../../../assets/images/blog/picoCTF/picoMiniByCMUAfricaPractice/image.png)

然後上傳 `.php.jpg`，內容是簡單的 web shell  
Windows 一直把我的檔案辨識成異常檔案，所以我只能在虛擬機裡面操作

![以 GET 參數 cmd 執行系統指令的 PHP web shell](../../../assets/images/blog/picoCTF/picoMiniByCMUAfricaPractice/image-1.png)
...
想說解題過程修一下再發  
但是想起來的時候已經快過一年 ฅ^•ﻌ•^ฅ  
picoCTF 網站現在也改名為 CyLab Security Academy 了  
還是直接發好了w
