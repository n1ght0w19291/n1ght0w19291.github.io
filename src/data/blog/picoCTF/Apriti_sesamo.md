---
title: "Apriti sesamo"
description: "Solving the Apriti sesamo challenge from picoCTF."
pubDatetime: 2025-07-13T09:00:00+08:00
tags: ["picoCTF", "Web"]
parentPost: "picoctf"
draft: false
---
...
![index](../../../assets/images/blog/picoCTF/Apriti_sesamo/image.png)

有先試試看是不是 sql injection ，但是沒有甚麼反應

![login](../../../assets/images/blog/picoCTF/Apriti_sesamo/image-1.png)

嘗試 `username=admin&pwd[0]=admin` ，出現 error message，推測與 PHP 的 array input 特性有關

![alt text](../../../assets/images/blog/picoCTF/Apriti_sesamo/image-2.png)

從 error message 可以知道有用 `sha1()` 去驗證

之後沒有甚麼想法就去看題目給的提示，提示是 `Backup file` ，檢查出存在 `/impossibleLogin.php~`，程式註解中有判斷的邏輯

![alt text](../../../assets/images/blog/picoCTF/Apriti_sesamo/image-3.png)
...
![alt text](../../../assets/images/blog/picoCTF/Apriti_sesamo/image-5.png)

得到 flag

![alt text](../../../assets/images/blog/picoCTF/Apriti_sesamo/image-4.png)
